  ...
  kernel: {
    ...
    rules: {
      type: {
        ...
        query_dnssec: 'query_dnssec',
        query_client_subnet: 'query_client_subnet',
    ...
    dns: {
      ...
      rules: {
        ...
        tag: {
          name: 'Tag',
          none: 'No Response Match',
          latest: 'Latest Untagged',
          tagged: 'Tagged Response',
        },
      },
    },
    mode: 'Mode',
